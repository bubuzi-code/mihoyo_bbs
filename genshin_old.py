...
if __name__ == "__main__":
  ...
  if code in [0, -5003]:
    ...
    logging.info(result)
    requests.post("https://sc.ftqq.com/SCU127892Tdbb6a5c63a890b0583d44465b82fd4c65fb5d17b21ebc.send",data = {'text':'原神签到','desp':'签到成功'})
  else:
    logging.info(result)
    exit(-100)
    requests.post("https://sc.ftqq.com/SCU127892Tdbb6a5c63a890b0583d44465b82fd4c65fb5d17b21ebc.send",data = {'text':'原神签到','desp':'签到失败'})
